...
public interface Constant {
	...
	// Online
	// final static String GOOGLE_CLIENT_ID =
	// "163881565295-ngpkhb4hie9emdmki7mta52sitbiinbt.apps.googleusercontent.com";
	// final static String APP_LINK =
	// "http://hakuna-contacta.appspot.com/HakunaContacta.html";
	...
	final static List<String> SCOPES = Arrays.asList("http://www.google.com/m8/feeds");

	// Use for running on GAE
	// final static String OATH_CALLBACK =
	// "http://tennis-coachrx.appspot.com/authSub";
